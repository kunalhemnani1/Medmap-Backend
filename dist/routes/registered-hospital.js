...
import { listMyHospitals, getPublicHospitals, getHospitalById, createHospital, updateHospital, listDoctors, addDoctor, removeDoctor, listPrices, addPrice, removePrice, createAppointment, listPatientAppointments, listHospitalAppointments, updateAppointmentStatus, createReview, listReviews, listDoctorAppointments, adminListHospitals, adminVerifyHospital, adminListAppointments, } from "../controllers/registered-hospital.controller.js";
const router = Router();
